...
public class Day3 {
    ...
    public static void main(String[] args) {
        ...
        sll.display();
        sll.addNodeFront(scan.nextInt());
        sll.display();
        sll.addNodeIndex(scan.nextInt(), scan.nextInt());
        sll.display();
        sll.deleteNode(scan.nextInt());
        sll.display();
        sll.deleteLastNode();
        sll.display();
        sll.deleteFirstNode();
        sll.display();
        sll.deleteNodeValue(scan.nextInt());
        sll.display();
        sll.replace(scan.nextInt(), scan.nextInt());
        sll.display();
        sll.reverse();
        sll.display();
        System.out.println(sll.findMax());
        System.out.println(sll.findMin());
        sll.printIndex(scan.nextInt());
        scan.close();
    }
}
